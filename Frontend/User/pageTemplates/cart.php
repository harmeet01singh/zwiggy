...
$title="Cart";
 include("../header.php");
$carts = $data->query('SELECT * FROM ((orders INNER JOIN food_item ON orders.food_id=food_item.food_id )INNER JOIN hotel ON food_item.hotel_id=hotel.hotel_id )ORDER BY order_date desc');
